...
//     description:
//       'Market Dynamics and the Impact of Taxation - Comprehensive analysis of cryptocurrency taxation framework in India.',
...
//     venue: '10th International P2P Financial System 2024, Dubai',
//     description:
//       'Evaluating the Role of Blockchain and Cryptocurrency in Advancing Financial Inclusion in India.',
...
//     description:
//       'Heat Design and Development of an Unmanned Aerial Vehicle - Technical research on UAV development.',
//     tag: 'Engineering Innovation',
//     image: '/assets/images/pic_drone2.jpeg',
...
//     venue: 'FLAMES Scopus Indexed Conference, India, 2020',
//     description:
//       'Design and Optimization and Computational Analysis - Thermal analysis and optimization of internal combustion engines.',
//     tag: 'Thermal Analysis',
//     image: '/assets/images/research4.jpeg',
//   },
//   {
//     title: 'FSW Optimization using AI Bangkok, Thailand',
//     venue: 'ISFT-2018, Bangkok, Thailand',
//     description:
//       'Prediction of optimum welding parameters using Genetic Algorithm and ANN.',
//     tag: 'AI & Optimization',
...
//     description:
//       'Analysis of Turbine Blade Heat - Thermal analysis and optimization of turbine blades.',
//     tag: 'Thermal Analysis',
...
//             Published research papers in international conferences covering
//             cryptocurrency taxation, blockchain technology, financial
//             inclusion, and engineering innovations.
//           </p>
//         </motion.div>
...
//                     pub.imagePosition === 'bottom'
//                       ? 'object-bottom scale-90'
//                       : 'object-center'
//                   }`}
//                 /> */}
//                <img
...
const publications = [
  ...
  },
  {
    ...
    tag: 'Engineering Innovation',
    image: '/assets/images/pic_drone2.jpeg',
    imageStyle: { objectPosition: 'center' } // ✅ CHANGED (only for 3rd image)
  },
  {
    title: 'Heat Transfer Analysis in IC Engines',
    venue: 'FLAMES Scopus Indexed Conference, India, 2020',
            ...
            >
              ...
              <div className="aspect-video w-full overflow-hidden bg-gray-200">
                ...
                <img
                  ...
                  alt={pub.title}
                  className={`w-full h-full object-cover ${
                    i === 2 ? 'object-[center_26%]' : 'object-center'
                  }`}  // ✅ CHANGE (slightly top, not full top)
                />
